...
var HW_HEROES = [
  { id:'glad',   name:'전위',   emoji:'⚔️', cls:'전사', rarity:'SSR', hp:40, atk:13,
    skill:{ name:'쌍철극', cost:2, type:'strike', val:15, target:'enemy', desc:'적 1명에게 공격력+15 피해' } },
  ...
  { id:'shaman',  name:'방통',   emoji:'📜', cls:'책사', rarity:'SSR', hp:32, atk:8,
  ...
  { id:'ganning',  name:'감녕',   emoji:'🏹', cls:'기습', rarity:'SR', hp:30, atk:10,
    skill:{ name:'백기겁영', cost:2, type:'strike', val:12, target:'enemy', desc:'적 1명에게 공격력+12 피해' } },
  ...
  { id:'spear',   name:'안량',   emoji:'🔱', cls:'전사', rarity:'SR', hp:36, atk:10,
    skill:{ name:'창격', cost:2, type:'strike', val:12, target:'enemy', desc:'적 1명에게 공격력+12 피해' } },
  { id:'dancer',  name:'문추',   emoji:'🏹', cls:'궁수', rarity:'SR', hp:28, atk:8,
    skill:{ name:'연환사', cost:2, type:'multi', val:5, target:'enemy', desc:'무작위 적을 5회 공격' } },
  ...
  { id:'zhanghe',  name:'장합',   emoji:'🐎', cls:'기마', rarity:'SR', hp:34, atk:10,
    skill:{ name:'우회 기동', cost:2, type:'strike', val:11, target:'enemy', desc:'적 1명에게 공격력+11 피해' } },
  ...
  { id:'diaochan', name:'초선',   emoji:'💃', cls:'무희', rarity:'SSR', hp:32, atk:8, exclusive:'normalclear',
  ...
  { id:'weiyan',   name:'위연',   emoji:'🪓', cls:'전사', rarity:'SR', hp:36, atk:10,
    skill:{ name:'자오곡 기습', cost:2, type:'strike', val:12, target:'enemy', desc:'적 1명에게 공격력+12 피해' } },
  ...
  { id:'mb_zhaochun',   name:'조순',   emoji:'🐎', cls:'기마', rarity:'C',  hp:30, atk:7, exclusive:'mid',
    skill:{ name:'추격', cost:2, type:'strike', val:7, target:'enemy', desc:'적 1명에게 공격력+7 피해' } },
  ...
  { id:'mb_xiahoushang',name:'하후상', emoji:'⚔️', cls:'전사', rarity:'C',  hp:32, atk:7, exclusive:'mid',
    skill:{ name:'위군 돌격', cost:2, type:'strike', val:7, target:'enemy', desc:'적 1명에게 공격력+7 피해' } },
  ...
  { id:'mb_wangshuang', name:'왕쌍',   emoji:'🪓', cls:'전사', rarity:'R', hp:36, atk:9, exclusive:'mid',
    skill:{ name:'유성추', cost:2, type:'strike', val:9, target:'enemy', desc:'적 1명에게 공격력+9 피해' } },
...
var HW_WEAPONS = [
  ...
  { id:'cixiong',  name:'자웅일대검', emoji:'⚔️', desc:'치명타 확률 +15%, 기본 공격 3회 (장수 컬렉션 완료 보상)', effect:{ crit:0.15, tripleStrike:true }, exclusive:'collection' },
  ...
  { id:'tiebian',  name:'철편(鐵鞭)', emoji:'🏏', desc:'공격력 +5, 주공 최대 HP +10', effect:{ atk:5, lordHp:10 } },
  ...
  { id:'wangujian',name:'완고검',     emoji:'🗡️', desc:'공격력 +4, 주공 최대 HP +13', effect:{ atk:4, lordHp:13 } },
  ...
  { id:'baihuyao', name:'백호요대',   emoji:'🥋', desc:'주공 HP +20, 치명타 +6%',   effect:{ lordHp:20, crit:0.06 } },
