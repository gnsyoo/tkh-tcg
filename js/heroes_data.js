...
var HW_HEROES = [
  ...
  { id:'mage',   name:'순욱',   emoji:'📜', cls:'책사', rarity:'R', hp:22, atk:5,
    skill:{ name:'계책', cost:2, type:'buff', val:6, target:'ally', desc:'아군 1명 공격력 +6 (전투 동안)' } },
  { id:'archer', name:'황충',   emoji:'🏹', cls:'궁수', rarity:'SR', hp:24, atk:6,
  ...
  { id:'valk',   name:'태사자', emoji:'🏹', cls:'궁수', rarity:'SR', hp:28, atk:7,
  ...
  // ---- 추가 장수 ----
  { id:'cavalier',name:'마초',   emoji:'🐎', cls:'기마', rarity:'SR', hp:34, atk:8,
    skill:{ name:'서량철기', cost:2, type:'strike', val:8, target:'enemy', desc:'적 1명에게 공격력+8 피해' } },
  { id:'ninja',   name:'여몽',   emoji:'🗡️', cls:'기습', rarity:'C', hp:22, atk:9,
    skill:{ name:'백의도강', cost:1, type:'multi', val:3, target:'enemy', desc:'무작위 적을 3회 공격' } },
  { id:'shaman',  name:'방통',   emoji:'📜', cls:'책사', rarity:'R', hp:24, atk:6,
    skill:{ name:'회생계', cost:2, type:'heal', val:14, target:'lowestAlly', desc:'가장 약한 아군 14 회복' } },
  ...
  { id:'bulwark', name:'허저',   emoji:'🛡️', cls:'수호', rarity:'SR', hp:46, atk:4,
    skill:{ name:'호위', cost:2, type:'shield', val:15, target:'ally', desc:'아군 1명에게 방어막 15' } },
  { id:'bard',    name:'서서',   emoji:'📜', cls:'책사', rarity:'SR', hp:26, atk:5,
  ...
  { id:'jiangwei', name:'강유',   emoji:'⚔️', cls:'전사', rarity:'SR', hp:32, atk:8,
    skill:{ name:'기산북벌', cost:2, type:'strike', val:8, target:'enemy', desc:'적 1명에게 공격력+8 피해' } },
  { id:'huanggai', name:'황개',   emoji:'🔥', cls:'수호', rarity:'C', hp:40, atk:6,
  ...
  { id:'templar',name:'도겸',   emoji:'🏯', cls:'수호', rarity:'C', hp:36, atk:6,
  ...
  { id:'spear',   name:'안량',   emoji:'🔱', cls:'전사', rarity:'R', hp:30, atk:8,
  ...
  { id:'druid',  name:'정욱',   emoji:'📜', cls:'책사', rarity:'R', hp:30, atk:5,
  ...
  { id:'yuejin',   name:'악진',   emoji:'🗡️', cls:'전사', rarity:'C', hp:30, atk:8,
  ...
  { id:'gongsunzan',name:'공손찬',emoji:'🐎', cls:'기마', rarity:'C', hp:34, atk:8,
