...
var HW_HEROES = [
  ...
  { id:'shaman',  name:'방통',   emoji:'📜', cls:'책사', rarity:'SSR', hp:32, atk:7,
    skill:{ name:'회생계', cost:3, type:'heal', val:16, target:'self', desc:'주공 16 회복' } },
  ...
  { id:'templar',name:'도겸',   emoji:'🏯', cls:'수호', rarity:'C', hp:36, atk:5,
    skill:{ name:'성벽 방어', cost:2, type:'shield', val:12, target:'self', desc:'주공 방어막 +12' } },
